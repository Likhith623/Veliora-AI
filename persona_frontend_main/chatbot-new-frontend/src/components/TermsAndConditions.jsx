...
const TermsAndConditions = () => {
  return (
    <div className="container rounded-3xl bg-slate-300 bg-opacity-50 backdrop-blur-md px-12 py-8 text-black">
      <h1 className="text-3xl font-bold mb-6 text-center">
        Terms And Conditions
      </h1>
      {/* <p className="mb-4"><strong>Last updated:</strong> July 29, 2024</p> */}
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-8 mb-4">
          <li>
            By email:{" "}
            <a
              href="mailto:support@localhost:3000"
              className="text-blue-500 hover:underline"
            >
