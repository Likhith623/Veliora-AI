                  ...
                  let cleanedMsgText = rawMsgText
                    ...
                    .replace(
                      /\[(?:game_end|GAME_END|activity_end|ACTIVITY_END)\]/gi,
                      "",
                    )
                    .replace(
                      /\[(?:call_end|CALL_END|voice_call_end|VOICE_CALL_END)\]/gi,
                      "",
                    )
                    ...
                    .replace(
                      /Generated a selfie with emotion:.*?(?:\(Media:.*?\))?/gi,
                      "",
                    )
                    .replace(
                      /\(Media:\s*(https?:\/\/[^\s)]+)\)/gi,
                                              ...
                                              <div className="flex flex-col gap-2 relative z-10 w-full min-w-[200px]">
                                                {inlineAudioUrl && (
                                                  <audio
                                                    controls
                                                    src={inlineAudioUrl}
                                                    className="w-full h-10 rounded-full bg-white max-w-[280px]"
                                                    preload="metadata"
                                                  />
                                                )}
                                                {textContent && (
